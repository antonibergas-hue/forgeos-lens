...
// Mission Control palette — ported from the platform's mission-control
// frontend tailwind config so this client renders with the same dark
// GitHub-esque theme as the operator's Mission Control board.
module.exports = {
  darkMode: ["class"],
